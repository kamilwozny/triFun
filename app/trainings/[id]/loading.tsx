export default function TrainingDetailsLoading() {
  return (
    <div className="max-w-4xl mx-auto p-4 lg:p-6 space-y-8">
      ...
      <div className="bg-white rounded-xl shadow-lg p-4 lg:p-6">
        <div className="flex items-center gap-2 mb-4">
          <div className="skeleton h-5 w-5 bg-neutral-200" />
          <div className="skeleton h-6 w-24 bg-neutral-200" />
        </div>
        <div className="skeleton w-full h-64 bg-neutral-200 rounded-lg" />
      </div>
